...
local indicatorOverrideSt = { [1] = styles.indicator.varlocal and styles.indicator.varlocal.over, 
                              [2] = styles.indicator.varglobal and styles.indicator.varglobal.over,
                              [0] = styles.indicator.fncall and styles.indicator.fncall.over}
...
function IndicateAll(editor, lines, linee)
  ...
  local function IndicateOne(indic, pos, length)
    if indicatorOverrideSt[indic] then
      local es = editor:GetEndStyled()
      editor:StartStyling(pos-1, 31)
      editor:SetStyling(length, indicatorOverrideSt[indic])
      editor:StartStyling(es, 31)
    else
...
function CreateEditor()
  ...
  editor:Connect(wxstc.wxEVT_STC_UPDATEUI,
    function ()
      ...
      -- IndicateAll(editor,minupdated or firstline,lastline)
      editor.ev = {}
    end)
